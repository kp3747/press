...
/Fd"build\win_%config%\press.pdb" ^
...
"press\build\unity_press.c" "parse\lib\unity_parse.c" /link /OPT:ref /subsystem:console /incremental:no libucrt.lib Comdlg32.lib Shell32.lib User32.lib /LIBPATH:%vc_lib% /LIBPATH:%sdk_lib% /LIBPATH:%ucrt_lib%
